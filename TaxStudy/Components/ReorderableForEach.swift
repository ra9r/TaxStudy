...
//
//  Article explainer: https://danielsaidi.com/blog/2023/08/30/enabling-drag-reordering-in-swiftui-lazy-grids-and-stacks
...
private extension ReorderableForEach {
    func contentView(for item: Item) -> some View {
        content(item)
            .opacity(active == item && hasChangedLocation ? 0.3 : 1)
            .onDrop(
                of: [.text],
